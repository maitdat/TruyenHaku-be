...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruyenHakuModels.Entities.Account.UserAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TruyenHakuModels.Entities.Application.Author", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TruyenHakuModels.Entities.Account.UserAccount", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TruyenHakuModels.Entities.Application.Chapter", b =>
                {
                    b.HasOne("TruyenHakuModels.Entities.Application.Manga", "Manga")
                        .WithMany("Chapters")
            ...
            modelBuilder.Entity("TruyenHakuModels.Entities.Application.Manga", b =>
                {
                    b.HasOne("TruyenHakuModels.Entities.Application.Author", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("TruyenHakuModels.Entities.Application.MangaCategory", b =>
                {
                    b.HasOne("TruyenHakuModels.Entities.Application.Category", "Category")
                        .WithMany()
